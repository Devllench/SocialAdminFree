...
class RequestClintClass(object):
    def __init__(self, url_path_info=None, answer_page=None):
        self.url_path_info = url_path_info # получаем
